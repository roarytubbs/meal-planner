...
export function UndoToast({ toast, onDismiss, onUndo }) {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 z-50 w-[min(92vw,420px)] -translate-x-1/2 rounded-xl border border-emerald-200 bg-white/95 p-3 shadow-xl backdrop-blur">
